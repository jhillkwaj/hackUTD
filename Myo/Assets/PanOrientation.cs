...
public class PanOrientation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (thalmicMyo.xDirection == Thalmic.Myo.XDirection.TowardWrist)
        {
            ...
            //transform.rotation = 
            Quaternion q = new Quaternion(transform.localRotation.x,
        ...
        Vector3 vec3 = q.eulerAngles;
        if(vec3.y>0 && vec3.y <90)
            transform.position = new Vector3(5 * Mathf.Atan(vec3.y*2*Mathf.PI/360), transform.position.y, transform.position.z);
        else if(vec3.y>270)
            transform.position = new Vector3(5 * Mathf.Atan((vec3.y-360)*2*Mathf.PI/360), transform.position.y, transform.position.z);
        else if(vec3.y == 0)
